    ...
    return (
        <>
            <div className={`absolute top-0 left-0 h-screen w-screen bg-white transform ${open ? "-translate-x-0" : "-translate-x-full"} transition-transform duration-300 ease-in-out filter drop-shadow-md`}>
                ...
                <div className="flex sticky flex-col ml-6 my-4 space-y-4 text-md text-[#0B0B45] font-medium">
                    <Link href="/">
                        <a className="inline-flex hover:text-blue-400" onClick={() => setTimeout(() => {setOpen(!open)}, 100)}>
                            Home
                        </a>
                    </Link>
                    <Link href="/about">
                ...
                <button className="uppercase mt-8 border px-4 py-1 ml-6 rounded-md font-medium tracking-wide bg-[#070077] text-white hover:bg-blue-600 hover:text-white transition duration-200 shadow-lg">
                    Appointments
                </button>
            </div>
        </>
...
function Header() {
    ...
    return (
        <>
            <div className="px-4 py-1 bg-[#070077] text-white">
            ...
            <header className="sticky top-0 z-[1000] flex items-center justify-between px-2 h-[64px] md:px-12 shadow-md">
                <Image 
                    src="/images/webinoxmedia.png" 
                    alt="" 
                    width={180} 
                        ...
                        <div className="hidden ml-4 md:flex items-center space-x-4 text-[#0B0B45]">
                            <Link href={"/"}>
                                <a className="header-link group">
                                    <HomeIcon className="h-4 group-hover:animate-bounce group-hover:text-blue-400" />
                            ...
                            <Link href={"/about"}>
                                <a className="header-link group">
                                    <UserGroupIcon className="h-4 group-hover:animate-bounce group-hover:text-blue-400" />
                            ...
                            <Link href={"/services"}>
                                <a className="header-link group">
                                    <SearchIcon className="h-4 group-hover:animate-bounce group-hover:text-blue-400" />
                            ...
                            <Link href={"/portfolio"}>
                                <a className="header-link group">
                                    <FolderIcon className="h-4 group-hover:animate-bounce group-hover:text-blue-400" />
                            ...
                            <Link href={"/contact"}>
                                <a className="header-link group">
                                    <DotsCircleHorizontalIcon className="h-4 group-hover:animate-bounce group-hover:text-blue-400" />
